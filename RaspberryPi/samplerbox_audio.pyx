##  SamplerBox
#
#  Original audio engine developed by
#  Joseph Ernest (twitter: @JosephErnest, mail: contact@samplerbox.org)
#  license CC3.0 SA
#  (http://creativecommons.org/licenses/by-sa/3.0/)
#
#  samplerbox_audio.pyx: Audio engine for Cython
#
#  Revision: Enrico Miglino <balearicdynamics@gmail.com>
#  Adapted to compile for the Python3 environment
#  Date: September 2020
#  IMPORTANT: Read the setup.py comments on how to setup and compile Cython on Python 3
#
# DO NOT DELETE THE LINE COMMENT BELOW! IT IS A CYTON COMPILER STATEMENT
